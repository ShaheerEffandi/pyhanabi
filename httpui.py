...
class MyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def perform_response(s):
        ...
        if gid is None or game is None or path.startswith("/restart/"):
            ...
            s.wfile.write(b'<li><a href="/new/probabilistic">Probabilistic Player 6CCS3PRJ Shaheer Effandi</a></li>\n')
        ...
        s.wfile.write(show_game_state(game, player, turn, gid, replay).encode('utf-8'))
    ...
    def add_choice(s, name, question, answers, default=-1):
        s.wfile.write(b"<p>")
        s.wfile.write((question + "<br/>").encode('utf-8'))
    ...
    def consentform(s):
        s.wfile.write(b"<html><head><title>Hanabi</title></head>\n")
        s.wfile.write(b'<body>\n')
        s.wfile.write((consent.consent).encode('utf-8'))
